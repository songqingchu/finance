...
public class Fetch_M1_D  {
	...
	public static Filter normalFilter=new com.taobao.finance.filter.Filter.NormalFilter();
	public static Filter oldFilter=new Fetch_M1_D.Filter1();
	...
	static{
        ...
        if(dir!=""){
        	//map=FetchUtil.readFileMapAbsoluteForHolding(dir+"\\"+FetchUtil.FILE_DUO_X);
        }
	}
