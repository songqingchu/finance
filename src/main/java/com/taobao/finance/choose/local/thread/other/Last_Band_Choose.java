...
public class Last_Band_Choose extends Local_Choose_MultiThread_Base{

	public static void main(String args[]){
		//Hisdata_Base.setLocalAnasysIncludeToday(false);
        new Last_Band_Choose().choose();
	}
...
class LB_Task implements Callable<List<Stock>> {

	private List<Stock> l;
    private int idx=1;
	
	public LB_Task(List<Stock> l,int idx) {
		this.l = l;
		this.idx=idx;
	}
