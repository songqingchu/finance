...
public class MouseHook {
	...
	public static void main(String[] args) {
		try {
			final MouseHook mouseHook = new MouseHook();
				...
				public LRESULT callback(int nCode, WPARAM wParam, MouseHookStruct lParam) {
					if (nCode >= 0) {
						...
						case MouseHook.WM_MOUSEMOVE:
							...
							System.out.println("mouse move left button down, x="+ (lParam.pt.x) + " y=" + lParam.pt.y);
							break;
						case MouseHook.WM_LBUTTONDOWN:
							System.err
									.println("mouse down left button down, x="
											+ lParam.pt.x + " y=" + lParam.pt.y);
							break;
						case MouseHook.WM_LBUTTONUP:
							System.err.println("mouse up left button up, x="
									+ lParam.pt.x + " y=" + lParam.pt.y);
							break;
